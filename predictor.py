...
#root = Tk()
p.geometry('1225x900+30+30')
p.title("Predictor Page")                        
p["bg"] = "#e8f8fa"  
...
def enter():
    ...
    b = np.array([[0, area.get(), 0, 0, 0, room.get(), age.get(), 0, 0, 0, 0, 0, 0]])
    #print(b)
    a = model.predict(b)
    d=Entry(font="17")
    d.place(x=980,y=550)
    d.insert(0,a*82410)
    #d.place(x=700,y=150)
    Label(text="Predicted price(in Rupees)",font="arial 17 bold",fg="white",bg="#485c63").place(x=650,y=550)
...
l3 = Label(text=" No. of bedrooms ",fg="white",bg="#485c63",font="arial 17 bold").place(x=700,y=220)
